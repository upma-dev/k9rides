...
export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    HELP_SUPPORT: "/food/admin/pages-social-media/help_support",
    HELP_SUPPORT_PUBLIC: "/food/pages/help_support",
    ...
    PETPOOJA_SETTINGS: "/food/admin/petpooja/settings",
    PETPOOJA_SYNC_LOGS: "/food/admin/petpooja/sync-logs",
  },
